...
type CriterionType = "yesno" | "rate15" | "checkbox";
...
const SCORING_CRITERIA: Criterion[] = [
...
const CRITERIA_BY_CATEGORY: Record<string, Criterion[]> = CATEGORY_ORDER.reduce(
  (acc, cat) => {
...
const TOTAL_CRITERIA = SCORING_CRITERIA.length;
                      ...
                      <tr key={criterion.id} className="border-t hover:bg-muted/20">
                        ...
                        {swimmers.map((swimmer) => {
                          ...
                          return (
                            <td
                              key={swimmer.id}
                              className={`p-3 border-l align-middle ${isMissing ? "bg-red-100" : ""}`}
                            >
                              <ScoreControl
                                criterion={criterion}
                                value={value}
