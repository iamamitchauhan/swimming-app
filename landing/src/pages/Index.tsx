    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img
            src={heroImg}
            alt="Competitive swimmer in pool"
            width={1920}
            height={1080}
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:py-28">
          <div className="flex flex-col justify-center text-white">
            ...
            <p className="mt-5 max-w-xl text-lg text-white/85">
              Browse available tryouts, reserve slots, and track registrations all in one place —
              designed for busy swim parents.
            </p>
      ...
      <section className="mx-auto mt-8 max-w-7xl px-4 sm:px-6">
        <div className="grid grid-cols-2 gap-3 rounded-2xl border border-border/60 bg-card p-4 shadow-lift sm:grid-cols-4 sm:gap-6 sm:p-6">
          ...
          <Stat
            ...
            value={stats?.participatingClubs}
          />
        </div>
      </section>
...
function Stat({
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-accent text-primary [&_svg]:h-5 [&_svg]:w-5">
        {icon}
      </span>
