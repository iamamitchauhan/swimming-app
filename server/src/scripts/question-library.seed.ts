...
const QUESTION_LIBRARY = [
    ...
    questions: [
      {
        ...
        meta: { inputType: "swim-time", unitOptions: ["SCY", "SCM", "LCM"] },
      },
      {
        type: "text",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        type: "radio",
        label: "50 Free — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
      {
        type: "radio",
        label: "50 Back — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
      {
        type: "radio",
        label: "50 Breast — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
      {
        type: "radio",
        label: "50 Fly — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
      {
        type: "radio",
        label: "100 Free — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
      {
        type: "radio",
        label: "100 Back — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
      {
        type: "radio",
        label: "100 Breast — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
      {
        type: "radio",
        label: "100 Fly — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
      {
        type: "radio",
        label: "200 IM — Cut / Standard Achieved",
        required: false,
        options: ["AAAA", "AAA", "AA", "A", "BB", "B", "C", "None / Not yet achieved"],
      },
    ],
