...
const QUESTION_LIBRARY = [
  {
    ...
    questions: [
      ...
      {
        type: 'text',
        label: 'Best swim time — 50 Free yds or meters',
        required: false,
        placeholder: 'e.g. 45.23',
      },
      {
        type: 'text',
        label: 'Best swim time — 100 Free yds or meters',
        required: false,
        placeholder: 'e.g. 1:23.45',
      },
      {
        type: 'text',
        label: 'Best swim time — 100 Back yds or meters',
        required: false,
        placeholder: 'e.g. 1:30.00',
      },
      {
        type: 'text',
        label: 'Best swim time — 100 IM yds or meters',
        required: false,
  ...
  },
  {
    ...
    questions: [
      ...
      { type: 'radio',    label: 'Favorite Stroke',                         required: false, options: ['Freestyle', 'Backstroke', 'Breaststroke', 'Butterfly', 'IM / No preference'] },
      { type: 'text',     label: 'T-Shirt Size',                            required: false, placeholder: 'e.g. Youth M, Adult L' },
      { type: 'radio',    label: 'How did you hear about this tryout?',     required: false, options: ['Email', 'Social Media', 'Word of Mouth', 'School', 'Website', 'Other'] },
    ],
  },
  {
    sortOrder: 2,
    category: '⏱ Best Times',
    questions: [
      { type: 'text', label: 'Best time — 50 Free (yds or meters)',    required: false, placeholder: 'e.g. 28.45' },
      { type: 'text', label: 'Best time — 50 Back (yds or meters)',    required: false, placeholder: 'e.g. 33.10' },
      { type: 'text', label: 'Best time — 50 Breast (yds or meters)',  required: false, placeholder: 'e.g. 38.00' },
      { type: 'text', label: 'Best time — 50 Fly (yds or meters)',     required: false, placeholder: 'e.g. 31.50' },
      { type: 'text', label: 'Best time — 100 Free (yds or meters)',   required: false, placeholder: 'e.g. 1:03.45' },
      { type: 'text', label: 'Best time — 100 Back (yds or meters)',   required: false, placeholder: 'e.g. 1:12.30' },
      { type: 'text', label: 'Best time — 100 Breast (yds or meters)', required: false, placeholder: 'e.g. 1:22.00' },
      { type: 'text', label: 'Best time — 100 Fly (yds or meters)',    required: false, placeholder: 'e.g. 1:10.00' },
      { type: 'text', label: 'Best time — 100 IM (yds or meters)',     required: false, placeholder: 'e.g. 1:15.00' },
      { type: 'text', label: 'Best time — 200 IM (yds or meters)',     required: false, placeholder: 'e.g. 2:35.00' },
      { type: 'text', label: 'Best time — 200 Free (yds or meters)',   required: false, placeholder: 'e.g. 2:20.00' },
      { type: 'text', label: 'Best time — 500 Free (yds or meters)',   required: false, placeholder: 'e.g. 6:10.00' },
    ],
  },
  {
    sortOrder: 3,
    ...
    questions: [
      { type: 'radio', label: 'Highest Time Standard / Cut Achieved (any event)', required: false, options: ['AAAA', 'AAA', 'AA', 'A', 'BB', 'B', 'C', 'None / Not yet achieved'] },
  ...
  },
  {
    ...
    questions: [
      ...
      { type: 'radio',    label: 'Preferred Training Group Level',                   required: false, options: ['Beginner / Developmental', 'Intermediate / Age Group', 'Senior / Pre-Elite', 'Elite / National'] },
      ...
      { type: 'checkbox', label: 'Comfortable with Diving Starts From',              required: false, options: ['Starting blocks', 'Deck level', 'In-water start only', 'Not yet comfortable diving'] },
      { type: 'checkbox', label: 'Practice Availability (days per week)',            required: false, options: ['1–2 days', '3–4 days', '5–6 days', '7 days / unlimited'] },
  ...
  },
  {
    ...
    questions: [
      { type: 'textarea', label: 'Medical Conditions / Allergies Coaches Should Know About',          required: false, placeholder: 'List any conditions, medications, or allergies — or write "None"' },
      { type: 'radio',    label: 'Does the swimmer have asthma or exercise-induced breathing issues?', required: false, options: ['Yes', 'No', 'Managed with medication'] },
      { type: 'radio',    label: 'Has the swimmer had any injuries in the past 12 months?',           required: false, options: ['Yes — describe below', 'No'] },
      { type: 'textarea', label: 'Injury details (if applicable)',                                     required: false, placeholder: 'Describe any recent injuries or physical limitations' },
      ...
      { type: 'radio',    label: 'Is the swimmer cleared by a doctor for vigorous physical activity?', required: false, options: ['Yes', 'No', 'Has restrictions — see medical notes'] },
    ],
  },
];
...
async function seed(): Promise<void> {
  ...
  for (const entry of QUESTION_LIBRARY) {
    const result = await QuestionLibraryModel.updateOne(
  ...
  console.log(
    `[question-library.seed] Done — ${created} created, ${updated} updated, ` +
    `${QUESTION_LIBRARY.length - created - updated} unchanged.`,
  );
